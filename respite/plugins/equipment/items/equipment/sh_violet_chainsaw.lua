ITEM.name = "Violet Mk. II Chainsaw"
ITEM.desc = "Forearm integrated chainsaw using a blighted chainsaw chain obtained after the fight against the smiling hybrid"
ITEM.model = "models/props_junk/sawblade001a.mdl"
ITEM.class = "weapon_violet_chainsaw"
ITEM.uniqueID = "weapon_violet_chainsaw"
ITEM.slot = "melee"
ITEM.width = 1
ITEM.height = 1
ITEM.price = 0
