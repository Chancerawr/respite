...
COMMAND.uid = "defend"
COMMAND.name = "Defend"
COMMAND.desc = "Allows you to block an incoming attack on an ally, either with a weapon or your body. You must be near the target you wish to defend. A failure of this roll means that you will be hit instead, but your target will be protected. This roll can be used against bullets, but you must be able to see the enemy firing at the person you are defending. In that case, you are getting hit by the bullets in place of the one you're defending. This ability requires the Defender trait."
COMMAND.category = "special"
