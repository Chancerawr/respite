...
function ENT:Initialize()
	...
	self.agil = math.random(0,30)
	self.stre = math.random(0,30)
	self.accu = math.random(0,30)
	self.craf = math.random(0,30)
	self.endu = math.random(0,30)
	self.luck = math.random(0,30)
	self.perc = math.random(0,30)
	self.fort = math.random(0,30)
