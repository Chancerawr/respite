...
DISEASE.symptoms = {
	{
		text = {
			...
			"You feel winded, as if all the air vanished from your lungs."
		},
		cd = 7200,
	},
}
...
//
local DISEASE = {}
DISEASE.uid = "trait_haunted"
DISEASE.name = "Haunted"
DISEASE.desc = "You'll never be alone."
DISEASE.category = "Trait"
DISEASE.symptoms = {
	{
		text = {
			"A amalgamation of disembodied human limbs is wriggling on the ground nearby, it ignores you completely.",
			--play some gross barnacle sounds or something
			"You see a man shuffling along in the distance, his head is gone and is he covered in dried blood.",
			--"Where is it?" or something
			"You hear a scream from somewhere far away.",
			--!_?----!!----?!!----!-----
			--play a sound
			"An unnaturally tall creature is staring straight at you from nearby. It seems to be trying very hard to make eye contact with you.",
			--Can you see me? Can you?
			"A decrepit child-like figure drags its broken leg across the ground as it wanders around aimlessly.",
			--play a sound maybe
			"What appears to be the remains of an armored man are crawling along the ground, his chest is gouged open and many of his internal organs are missing.",
			--"Give it back" or something
			"A regular looking cat rubs against your leg and meows cutely, if you try to touch it, your hand passes right through.",
		},
		cd = 7200,
	},
}
...
DISEASE.cure = {
	"Your blue haze addiction has been cured.",
}
