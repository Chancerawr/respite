...
if ( CLIENT ) then
	...
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_debris/wood_board04a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1, -4), angle = Angle(180, 91.023, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
