...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["element_name"] = { type = "Model", model = "models/props/cs_militia/axe.mdl", bone = "static_prop", rel = "", pos = Vector(11.947, 4.675, -4.676), angle = Angle(-1.17, 5.843, -75.974), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
