...
if ( CLIENT ) then
	...
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/warz/melee/fireaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1.363, -5), angle = Angle(180, 117.613, -9.205), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
