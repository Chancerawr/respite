...
if ( CLIENT ) then
	SWEP.PrintName      = "Crowbar Alternate"
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props/cs_militia/axe.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.456, -0.456, 5.908), angle = Angle(-1.024, 103.295, -8), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props/cs_militia/axe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1.363, -5), angle = Angle(180, 27.613, -9.205), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
