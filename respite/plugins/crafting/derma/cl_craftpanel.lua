...
function PANEL:Init()
	if (IsValid(nut.gui.crafttest)) then
		nut.gui.crafttest:Remove()
	end
	
	nut.gui.crafttest = self
...
netstream.Hook("nut_craftOpen", function()
	local craft = vgui.Create("nutCraftFrame")
end)
