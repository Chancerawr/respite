...
ENT.configTable = 
{
	[1] = { Color( 0, 128, 128 ), "common/warning.wav" },
	[4] = { Color( 0, 128, 128 ), "HL1/fvox/beep.wav" },
	[3] = { Color( 0, 128, 128 ), "HL1/fvox/bell.wav" },
	[2] = { Color( 0, 128, 128 ), "HL1/fvox/blip.wav" },
}
