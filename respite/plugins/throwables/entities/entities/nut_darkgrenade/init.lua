...
function ENT:Initialize()
	...
	self.Entity:SetMaterial("models/combine_advisor/mask")
	...
	local trail = util.SpriteTrail(self.Entity, self.Entity:LookupAttachment("fuse"), Color(75, 0, 130), true, 8, 1, 1, (1 / 9) * 0.5, "sprites/bluelaser1.vmt");
...
function ENT:Explode()
	self.Entity:EmitSound("ambient/explosions/explode_9.wav", 90, 50, 1);
...
--			else
				pl:SetNetworkedFloat("DARKED_END", endtime + CurTime());
--			end

			pl:SetNetworkedFloat("DARKED_START", CurTime());
		end
	end
