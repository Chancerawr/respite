...
In the Void, humans are referred to as drifters. The reason for this particular name is due to their somewhat nomadic state in regards to respites. Most often they do not stay in one single respite, but move through multiple throughout their lives. Drifters have many reasons to do this, but it is often personal and can vary from drifter to drifter. Some are searching for a way out, while others are searching for a new place to call home.
	<br/><br/>
Drifters are unique in that they are never created, they all come from the Faux. Generally after entering the Void, a drifter will be very confused, and vulnerable. Fortunately, new drifters almost always enter the Void in respites that already have a moderate drifter presence, meaning that not many are immediately thrown to the wolves. However, this does still happen from time to time. Drifters that survive alone are considered to be quite skilled and knowledgeable, some groups take to hiring them for more dangerous expeditions or to accomplish certain dangerous objectives.
	<br/><br/>
Drifters, with their strengths and numbers, are considered to be one of the strongest forces throughout the Void. It is commonly said that if all drifters were to unite, they could easily conquer all of the abandoned respites in the Void. However, due to the chaotic nature of the Void, and the seemingly infinite number of abandoned respites, this is likely an exaggeration of both power and ability. Nonetheless, the power of drifters is not to be underestimated by any regard. Drifters are responsible for destroying a number of seemingly impossibly strong threats, even creatures that many would consider as having god-like powers. Drifters are known to overcome all odds to survive, even when fighting against impossible odds and completely ridiculous powers. 
	<br/><br/>
The most significant of the drifters’ powers is the both conscious and unconscious ability to create. The mind of a drifter has an immense impact on the respite they are housed within, especially if that respite is their own. The emotions and mental state of drifters in an area passively create abominations, aberrations, and sometimes shades. They can also impact the weather, and bring about other anomalous events. Blood haze is a very common example of this. Drifters are also able to actively create Plastics that will obey and follow them, they can even train abominations and aberrations given the proper resources and time. Drifters are also the only known creatures to be able to create respites, and remarkably easily as well. 
	<br/><br/>
The drifters’ ability to create can also occasionally be directed towards their own or other drifters’ bodies. This is most commonly observed in blood haze mutations, but there are also less common occurrences of Drifters turning into aberrations, plastics, and shades as well. The malleable state of a drifter’s body is not limited to full transformations, and small changes in their body can happen over time. Drifters may accumulate shadowy body parts, or have entire sections of their body replaced with abomination flesh. It is rare to see an experienced Drifter without some sort of difference from regular human biology, and it is an important part of Drifter health to avoid more transformations whenever possible, for if the brain of a drifter is transformed, the creature ceases to be human, and becomes something else entirely. If the drifter’s mind is transformed, it is likely that the new creature will not retain the memories or personality of the drifter it came from. However, there are special cases where seemingly full transformations happen, and the drifter’s mind is left intact. This can happen with some aberration transformations, and even some plastic ones. shades generally retain the memories of the drifter before them, but they often become distorted and twisted, resulting in a being that somewhat resembles who it once was, but not quite. In the case of a full abomination transformation, no part of who the drifter once was ever survives and the mind is completely destroyed. Unfortunately, once a transformation of occurred, it is seemingly impossible to return the creature back to a drifter. No attempts to do so have ever succeeded.
	<br/><br/>
A transformed drifter is often fairly powerful right after creation, they are generally tougher, faster, and stronger than a typical creature, but that can vary. There does not seem to be any correlation between the drifter’s strength before and after transformation. A strong drifter may turn into a weak abomination. A weak drifter may transform into a truly monstrous aberration or abomination. However, the true power of a transformed drifter is not immediately after the transformation, but much later. Creatures such as these are capable of growing in power very rapidly, and can become very dangerous if not dealt with as soon as possible. Plasticized drifters may create and rally massive armies. Abominable and aberrative drifters may grow and mutate further, developing new abilities or shedding weaknesses. Drifter shades may rapidly absorb other shades, and develop very concerning abilities if left unchecked. 
	<br/><br/>
Drifter colonies rise and fall just like any other, but they do tend to last longer than those of plastics. There are some historical records referring to ancient drifter colonies, ones that supposedly flourished for hundreds if not thousands of years. However, there have been no witness accounts of finding any such place intact, only ruins of ancient cities. That being the case, it is believed that if these places exist, they are likely not in abandoned respites, but in a drifter’s own respite room. Such places are generally safer with less abominations and aberrations which would explain why some abandoned respites have seemingly freshly abandoned cities and massive ruins. However, this theory lacks an explanation for how the mental state of the drifter can survive for so long with such a thing affecting their mind, especially if there are multiple others living within. 
	<br/><br/>
Drifters use a variety of devices and tools, both those of real world origin, and those of Void origin. Most obvious for most is the Vending Machine, Fabricator, and Safe Box. These devices typically appear around drifter groups of no less than five, and seemingly appear somewhere in whatever abandoned respite they enter. They generally create a convenient area for drifters to congregate around due to their various uses, which leads to them becoming the heart of any drifter encampment. Drifters also make use of other various devices, such as the generator, the farms, refineries, portal devices, and much more. Some drifters even take to invent new tools and devices. These devices are often given to the Fabricator, which allows those in other respites to make use of them provided they have the materials necessary to create them.
	<br/><br/>
New drifters typically have completely human biology, but there are some differences and important traits to note. 
	<br/>
* Drifters tend to be at least eighteen years of age, but younger than eighty. 
	<br/>
* Drifters can eat anything that a human can, but it is not uncommon for a drifter to mutate in a way that allows or prohibits certain meals. 
	<br/>
* Drifters cannot become pregnant or give birth in the Void. It is unknown why exactly this is the case, but it seems to stem from the fact that new drifters cannot be created by other drifters under any circumstances. Furthermore, the effects of sexual intercourse appear to be poorly understood within the Void. It is known that drifters have an immense effect on their environment with their mental status. Thus, one would assume that intercourse would as well, due to the emotional impact of such a thing. However, no data currently exists that provides a link to what impact it might have at all. Most believe that something happens, but there is no indication of what that might be.
	<br/>
* Drifters do not age normally, and will always appear to be the same age unless acted upon by an outside force, such as an creature with time altering abilities. This means that drifters, unless killed or altered somehow, can potentially live forever.
	<br/><br/>
As mentioned before, most drifters undergo a variety of miscellaneous changes throughout their lives, either through their own volition, or through other unfortunate events. While uncommon, there have been drifters that have become stranger than aberrations, more terrifying than abominations, and more twisted than shades. With that in mind, all situations must be tinged with caution if there is ever any doubt of a creature’s identity, for no matter how changed a drifter is, as long as they are still a drifter, blood haze will still affect them.
	<br/><br/>
